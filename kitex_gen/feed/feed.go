...
type FeedResponse struct {
	...
	VideoList  *Video  `thrift:"VideoList,3" frugal:"3,default,Video" json:"VideoList"`
...
var FeedResponse_VideoList_DEFAULT *Video
...
func (p *FeedResponse) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("VideoList", thrift.STRUCT, 3); err != nil {
		goto WriteFieldBeginError
	}
